...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "_v-04732864/welcome.vue"
	  if (!module.hot.data) {
	  ...
	  methods: {
	    login: function login() {
	      ...
	      if (this.isValid()) {
	        ...
	        (0, _TOOL.sendAjax)('/login', infoObj, function (data) {
	          if (data.status === 1) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getIdendity = exports.sendAjax = undefined;

	var _config = __webpack_require__(16);

	var _ROUTER = __webpack_require__(3);

	var sendAjax = exports.sendAjax = function sendAjax(relativePath, infoObj, fn) {
	  $.post(_config.rootPath + relativePath, infoObj, fn, 'json');
	};

	var getIdendity = exports.getIdendity = function getIdendity(router) {
	  ...
	  methods: {
	    register: function register() {
	      ...
	      if (this.isValid()) {
	        ...
	        (0, _TOOL.sendAjax)('/register', infoObj, function (data) {
	          if (data.status === 1) {
	            _this.userName = '';
	            _this.password = '';
	            _this.type = '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  computed: {
	    idendity: function idendity() {
	      return (0, _TOOL.getIdendity)(this.$router);
	    }
	  },
	  components: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-1029469e/manager.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
